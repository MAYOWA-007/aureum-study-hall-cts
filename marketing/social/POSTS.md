# Aureum Study Hall — CTS social posts

Live project: https://mayowa-007.github.io/aureum-study-hall-cts/

## LinkedIn

Today I’m sharing the first release in the Aureum Study Hall series: **CTS Practice**.

It is a free, browser-based study experience built to help AV professionals practice the judgment behind the signal—not simply memorize isolated facts.

What’s included:

- 300 original, source-grounded practice questions
...
Independent study material. Not affiliated with, sponsored by, or endorsed by AVIXA. CTS® and AVIXA® are marks of AVIXA, Inc. No practice resource can guarantee a pass or predict a live examination.

#ProAV #AVTechnology #CTS #ProfessionalDevelopment #LearningDesign

## Reddit

### Suggested title

[Free resource] I built Aureum Study Hall — CTS: 300-question, local-first CTS practice

### Post body

I built a free CTS practice site as the first project in the **Aureum Study Hall** series.

The goal was to make something useful for actual study—not a thin quiz page or a claim that anyone can predict the live exam.

Features:

- 300 original practice questions
- 20, 60, 115, or 300-question sessions
...
I’d especially appreciate feedback on question clarity, rationale quality, accessibility, and anything that would make the practice workflow more useful.

Independent study resource. It is not affiliated with or endorsed by AVIXA, contains no live/leaked exam questions, and cannot guarantee a passing result. CTS® and AVIXA® are marks of AVIXA, Inc.
